...
* Descriptions should be written in plain English and avoid marketing language.
* Avoid using the word "free" in the Description column — free access is already a requirement for inclusion.
